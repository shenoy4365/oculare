    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.header}>Sign up with Oculare</Text>
          <Text style={styles.paragraph}>
            Let’s get your information so that we can get started with your
            retinal scan analysis
          </Text>

          {/* TextFields - the user's name, email, and password */}
          ...
          <TouchableOpacity style={styles.button} onPress={onSubmit}>
            <Text style={styles.buttonText}>Sign up with Oculare</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
